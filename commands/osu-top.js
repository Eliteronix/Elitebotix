...
async function drawTopPlays(input, osuApi) {
  ...
  for (let i = 0; i < scores.length && i < 10; i++) {
    roundedRect(ctx,canvas.width / 70,canvas.height / 8 + (canvas.height / 12) * i,canvas.width - canvas.width / 35,canvas.height / 13,canvas.height / 70);
    ...
    ctx.textAlign = "right";
    ctx.fillText(Math.floor(scores[i].pp) + "pp",(canvas.width / 35) * 34,canvas.height / 8 +(canvas.height / 12) * i +canvas.height / 13 / 2 +canvas.height / 70);
    ...
    ctx.fillStyle = "#FFFFFF";
    ctx.textAlign = "left";
    ctx.fillText(`${beatmap[0].title} by ${beatmap[0].artist}`,(canvas.width / 35) * 3,canvas.height / 8 + (canvas.height / 12) * i + canvas.height / 12 / 2);
    ...
    for (let j = 0; j < mods.length; j++) {
      ...
      ctx.drawImage(modImage,canvas.width / 35,canvas.height / 8 +(canvas.height / 12) * i +canvas.height / 13 / 2 -canvas.height / 31.25 / 2,canvas.width / 31.25,canvas.height / 31.25);
    }
  }
