	...
	async getOsuBeatmap(input) {
		...
		for (let i = 0; i < 3; i++) {
			if (!dbBeatmap) {
				...
				if (!err.stack.includes('utils.js:3840:') && !err.stack.includes('osu-matchtrack.js:475:') && !err.stack.includes('osu-matchtrack.js:676:')) {// && !err.stack.includes('osu-top.js:957:')) {
