	...
	async getOsuBeatmap(input) {
		...
		for (let i = 0; i < 3; i++) {
			if (!dbBeatmap) {
				...
				if (!err.stack.includes('utils.js:3274:') && !err.stack.includes('utils.js:3840:') && !err.stack.includes('osu-matchtrack') && !err.stack.includes('multiToBanchoScore') && !err.stack.includes('osu-top.js:956:') && !err.stack.includes('osu-score.js') && !err.stack.includes('osu-recent.js') && !err.stack.includes('osu-beatmap.js') && !err.stack.includes('osu-history.js')) {
